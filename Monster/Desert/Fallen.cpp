...
Fallen* Fallen::createMonster(std::vector<Point> points)//常规生成的木乃伊
{
...
Fallen* Fallen::createMonster(std::vector<Point> points,Point birthLocation,int pointCounter)//在长生军死亡的位置生成木乃伊
{
    auto monster = new Fallen();
    if (monster && monster->init())
    {
