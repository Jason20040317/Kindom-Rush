...
//////////////////返回按钮
	   ...
	   auto label = Label::createWithTTF("王国保卫战 ", "SohoGothicProMedium.ttf", 36);
	   label->setPosition(Point(size.width*0.5, size.height*0.75));
	   label->setColor(Color3B::BLACK);
	   addChild(label,1);

	   auto label0 = Label::createWithTTF("by C43 ", "SohoGothicProMedium.ttf", 28);
	   label0->setPosition(Point(size.width*0.7, size.height*0.7));
	   label0->setColor(Color3B::BLACK);
	   addChild(label0,1);


	   auto label1 = Label::createWithTTF("Yang ying fan", "SohoGothicProMedium.ttf", 26);
	   label1->setPosition(Point(size.width*0.5, size.height*0.6));
	   label1->setColor(Color3B::BLACK);
	   addChild(label1,1);

	   auto label2 = Label::createWithTTF("Lu yi ren", "SohoGothicProMedium.ttf", 26);
	   label2->setPosition(Point(size.width*0.5, size.height*0.5));
	   label2->setColor(Color3B::BLACK);
	   addChild(label2,1);

	   auto label3 = Label::createWithTTF("Li jun min", "SohoGothicProMedium.ttf", 26);
