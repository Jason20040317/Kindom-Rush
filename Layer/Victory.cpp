...
bool Victory::initVictory(int star,int gem)
{
	...
	auto ContinueSpriteOff=Sprite::createWithSpriteFrameName("button_continue_0001.png");//仿照初始文件的开关按钮逻辑
...
void Victory::showStar(int star)//胜利后的不同星数
{
	switch (star)
	{
	case(1):{
