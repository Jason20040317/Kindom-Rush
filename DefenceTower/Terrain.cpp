...
bool xh::Terrain::init(int type)
{
    ...
    listener->onTouchBegan = CC_CALLBACK_2(xh::Terrain::onTouchBegan, this);
	listener->onTouchEnded = CC_CALLBACK_2(xh::Terrain::onTouchEnded, this);
